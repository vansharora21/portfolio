(function ($) {
  ...
  $(document).ready(function () {
    ...
    if (typeof VanillaTilt !== 'undefined') {
      VanillaTilt.init(document.querySelectorAll("#portfolio .card, #about .bg-yellow, #about .bg-green, #about .bg-teal"), {
        max: 4,
        speed: 500,
        glare: true,
        "max-glare": 0.1,
    ...
    if (typeof VANTA !== 'undefined') {
      VANTA.NET({
        ...
        scale: 1.00,
        scaleMobile: 1.00,
        color: 0x3d2828,           // Very muted coral — subtle
        backgroundColor: 0x0a0a0a, // Matches deep bg-primary
        points: 8.00,              // Fewer points = cleaner
        maxDistance: 20.00,
        spacing: 22.00             // More spacing = less busy
      });
    }
